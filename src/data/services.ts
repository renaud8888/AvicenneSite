...
export const services: Service[] = [
  {
    ...
    image: asset('/images/services/pedodontie.jpg'),
    content: [
  ...
  },
  {
    ...
    image: asset('/images/services/carie.jpg'),
    content: [
  ...
  },
  {
    ...
    image: asset('/images/services/detartrage.jpg'),
    content: [
  ...
  },
  {
    ...
    image: asset('/images/services/endodontie.jpeg'),
    content: [
  ...
  },
  {
    ...
    image: asset('/images/services/prothese-amovible.jpg'),
    images: [
      asset('/images/services/prothese-amovible.jpg'),
      asset('/images/services/prothese-amovible-complete.jpg'),
      asset('/images/services/implant-amovible-partiel.jpg'),
    ],
    content: [
    ...
    sections: [{ title: 'PROTHÈSE AMOVIBLE PARTIELLE', image: asset('/images/services/prothese-amovible-complete.jpg') }],
    icon: Crown,
  ...
  },
  {
    ...
    image: asset('/images/services/blanchiment.jpg'),
    content: [
  ...
  },
  {
    ...
    image: asset('/images/services/orthodontie.jpg'),
    content: [
  ...
  },
  {
    ...
    image: asset('/images/services/couronne.jpg'),
    images: [
      asset('/images/services/couronne.jpg'),
      asset('/images/services/bridge.jpg'),
      asset('/images/services/inlay-onlay.jpg'),
    ],
    content: [
    ...
    sections: [
      { title: 'COURONNE', image: asset('/images/services/couronne.jpg') },
      { title: 'BRIDGE', image: asset('/images/services/bridge.jpg') },
      { title: 'INLAY-ONLAY', image: asset('/images/services/inlay-onlay.jpg') },
    ],
    icon: Crown,
  ...
  },
  {
    ...
    image: asset('/images/services/implant.jpg'),
    content: [
